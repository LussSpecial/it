 ...
 * Generated at: 2023-05-21 22:45:35 UTC
...
public final class adminNoticeList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<head>\r\n");
      out.write("<meta charset=\"UTF-8\">\r\n");
      out.write("<title>꿀TIPer 관리자 - 공지사항</title>\r\n");
...
if(request.getParameter("del")!=null){
	...
	out.print("</script>");
      ...
      out.write("<link href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/front/adminNoticeList.css\" rel=\"stylesheet\">\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      out.write("<script>\r\n");
      ...
      out.write("		location.href=\"updateMoveNotice?notice_num=\"+val;\r\n");
      out.write("	}\r\n");
      out.write("	\r\n");
      out.write("	\r\n");
      out.write("//전역변수정의\r\n");
      ...
      out.write("var search = $(\"#notice-search\").val();\r\n");
      out.write("\r\n");
      out.write("// 검색 버튼 클릭 이벤트\r\n");
      out.write("function btnSFnc() {\r\n");
      out.write("startDate = $(\"#start-date\").val();\r\n");
      out.write("endDate = $(\"#end-date\").val();\r\n");
      out.write("search = $(\"#notice-search\").val();\r\n");
      ...
      out.write("        url: 'adminNoticeList',\r\n");
      out.write("        data:  {\r\n");
      out.write("        	'notice_start': startDate,\r\n");
      out.write("        	'notice_end': endDate,\r\n");
      out.write("            'notice_search' : search\r\n");
      out.write("        },\r\n");
      ...
      out.write("    \r\n");
      out.write("	 chartHtml += \"<tr onclick='selTr(\"+dataList[i].notice_num +\")' style='cursor: pointer'><td>\"+(dataList[i].notice_num || \"\")+\r\n");
      out.write("	 \"</td><td  class='titleTd' title='\"+dataList[i].notice_title+\"' style='width:50%; text-overflow:ellipsis; overflow:hidden; white-space:nowrap;'>\" +(dataList[i].notice_title || \"\") + \"</td><td>\" + (dataList[i].notice_date || \"\") +\r\n");
      out.write("	    \"</td><td>\" + (dataList[i].notice_readcount || \"\") + \"</td><td>\" + (dataList[i].notice_pin || \"\");\r\n");
      out.write(" }\r\n");
      out.write(" \r\n");
      ...
      out.write("<h2 style=\"margin:40px 0px;\">공지사항 관리</h2>\r\n");
      out.write("\r\n");
      out.write("		\r\n");
      out.write("<button id=\"view-all-button\" onclick=\"viewAllFnc()\">전체목록보기</button>\r\n");
      out.write("<br>\r\n");
      out.write("<label for=\"start-date\">기간선택</label>\r\n");
      out.write("<input type=\"date\" id=\"start-date\" name=\"notice_start\" >\r\n");
      out.write("<label for=\"end-date\">~</label>\r\n");
      out.write("<input type=\"date\" id=\"end-date\" name=\"notice_end\" >\r\n");
      out.write("<input type=\"text\" id=\"notice-search\" name=\"notice_search\" placeholder=\"검색할 제목을 입력해주세요\">\r\n");
      ...
      out.write("<button type=\"button\" onclick=\"addNotice()\" id=\"addNotice\">공지사항 등록</button>\r\n");
      out.write("\r\n");
      out.write("				<br>\r\n");
      ...
      out.write("	                    <th style=\"width:15%\">날짜</th>\r\n");
      out.write("	                    <th style=\"width:10%\">조회수</th>\r\n");
      out.write("	                    <th style=\"width:10%\">고정여부</th>\r\n");
      out.write("	                </tr>\r\n");
      out.write("	            </thead>\r\n");
